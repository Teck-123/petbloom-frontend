...
SCHEMA_PATH = Path('/home/thecla/petbloom-frontend/back-end/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/thecla/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    def __init__(
        ...
        *,
        ...
        self.pet = actions.PetActions[models.Pet](self, models.Pet)
        ...
        self.wishlist = actions.WishlistActions[models.Wishlist](self, models.Wishlist)
