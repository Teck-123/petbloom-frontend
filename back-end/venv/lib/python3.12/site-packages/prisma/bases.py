...
class BasePet(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Pet']] = 'Pet'

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PetActions[_PrismaModelT]':
        from .client import get_client

        return actions.PetActions[_PrismaModelT](client or get_client(), cls)
...
class BaseCartItem(_PrismaModel):
    __prisma_model__: ClassVar[Literal['CartItem']] = 'CartItem'
...
class BaseWishlist(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Wishlist']] = 'Wishlist'

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.WishlistActions[_PrismaModelT]':
        from .client import get_client

        return actions.WishlistActions[_PrismaModelT](client or get_client(), cls)


class BaseOrder(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Order']] = 'Order'
...
class BaseOrderItem(_PrismaModel):
    __prisma_model__: ClassVar[Literal['OrderItem']] = 'OrderItem'
